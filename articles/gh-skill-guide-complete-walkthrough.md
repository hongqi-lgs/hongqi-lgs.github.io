---
title: "gh skill で AI エージェントにスキルを追加する完全ガイド"
emoji: "🧩"
type: "tech"
topics: ["GitHub", "AI", "AgentSkills", "ClaudeCode"]
published: true
---

> GitHub CLI v2.90.0 の新コマンド gh skill で、AI Agent のスキルパッケージを検索・インストール・公開。既存スキルの導入から自作スキルの公開まで、実践的に解説する。
